  ...
  return (
    <div className="bg-cyan-100 flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm flex flex-col justify-center">
        ...
        <h2 className="mt-8 text-center text-2xl font-bold leading-9 tracking-tight text-cyan-950">Login to your account</h2>
      </div>
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <div>
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="#" className="font-semibold text-cyan-900 hover:text-cyan-500">
                  Forgot password?
                </a>
              </div>
            </div>
        ...
        <Link
          href={actionURL}
          type="submit"
          className="flex w-full justify-center rounded-md bg-cyan-400 px-3 py-1.5 text-sm font-semibold leading-6 text-cyan-950 hover:text-cyan-100 shadow-sm hover:bg-cyan-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600 shadow-xl mt-2"
        >
          Login With Google
        </Link>
        ...
        {/* <p className="mt-10 text-center text-sm text-gray-500">
          ...
          <a href="./regis" className="font-semibold leading-6 text-cyan-600 hover:text-cyan-500">
            Register Now
          </a>
        </p> */}
      </div>
